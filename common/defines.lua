...
NCountry = {
	...
	IDEA_TO_TECH = -0.000,			-- percentage on tech reduction per idea.
	TECH_TIME_COST = 0.0,			-- tech grow with 0% cost over time (fucking shit idea paradox).
	...
	COLONIAL_NATION_GROWTH_IMPACT = 0.66,			-- colonies of colonial nations grow slower if desired.
...
NAI = {
	...
	PEACE_TERMS_PROTECTORATE_BASE_MULT = 100.0, -- only applied if the AI has vassalize priority
	...
	DIPLOMATIC_ACTION_COALITION_THREAT_FACTOR = 1.0, -- AI scoring for joining/forming coalition based on threat score
